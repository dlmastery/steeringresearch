...
# The harmful/benign prompts now come from ``steering_tutorials.common.data``
...
N_PER_CLASS = 500
N_EXTRACT = 300         # per class, used only to build the refusal direction (eval = 200/class)
SEED = 0
