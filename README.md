...
| 🟢 **Glossary (plain English)** — every term defined for non-specialists; each hypothesis page also opens with an "In Plain English" box | [hypotheses/GLOSSARY.md](hypotheses/GLOSSARY.md) |
