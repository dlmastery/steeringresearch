...
| E7 | Norm-relative alpha | A | A3 (coeff) | Normalizing alpha by ||h|| (relative steering) reduces cross-prompt variance vs absolute alpha. | Behavior-shift variance lower for relative vs absolute alpha [NEEDS VERIFICATION] | NEGATIVE/NULL on REAL AxBench (270M) — synthetic-ocean win did NOT generalize: on AxBench (concept500, n=500 concepts, off-family local judge AUC 0.68) real does NOT beat shuffled (real 0.046 vs shuf 0.056, delta −0.010, bootstrap CI [−0.0142,−0.0066], p=1.4e-6) — significant but NEGATIVE, both at floor at 270M; sign-blind auto-label "DIRECTIONAL" corrected to NEGATIVE (exp#118); Gemma-2-2B rerun pending. Prior SYNTHETIC "ocean" run was PROVISIONAL directional win (real>shuffled both scales Holm-corrected, 270M +0.135 p=4e-4; 1B +0.096 p=.014; exp#116/117, S-15) but did not generalize; screening: relative_add clean cliff, knee~10% ||h|| (C9b) | 3 | — |
