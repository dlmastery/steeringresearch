...
| E7 | Norm-relative alpha | A | A3 (coeff) | Normalizing alpha by ||h|| (relative steering) reduces cross-prompt variance vs absolute alpha. | Behavior-shift variance lower for relative vs absolute alpha [NEEDS VERIFICATION] | SUPPORTED(directional, scale-replicated; n=20 judge) but PROVISIONAL — real>shuffled both scales Holm-corrected (270M +0.135 p=4e-4; 1B +0.096 p=.014, bootstrap CIs exclude 0), fails strict ordinal gate (both) + matched-coherence (1B) (exp#116/117); screening: relative_add clean cliff, knee~10% ||h|| (C9b) | 3 | — |
